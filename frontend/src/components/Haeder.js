    ...
    <div className="main w-5/6 relative h-full mx-auto flex justify-between items-center">
      ...
      <div className="searchBar">
        <label class="relative block">
          ...
          <input onKeyUp={getSearch} id='serachInput' class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 " placeholder="Search for anything..." type="text" name="search"/>
        </label>
      </div>
      {
      ...
      <div className="describtion flex items-center">
        <div className="profileBx flex items-center mr-3">
          <div className="name font-main mr-1 hidden md:block">Hello {getFname}</div>
